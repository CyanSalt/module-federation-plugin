...
class ContainerEntryModule extends Module {
  ...
  getSourceString(runtimeTemplate) {
    ...
    for (const block of this.blocks) {
      ...
      getters.push(
        `${JSON.stringify(name)}: ${this.basicFunction('', str)}`,
      )
    }
    ...
    return Template.asString([
      ...
      '};',
      `var get = ${this.basicFunction('module', [
        'return (',
        Template.indent([
          `${RuntimeGlobals.hasOwnProperty}(moduleMap, module)`,
          Template.indent([
            '? moduleMap[module]()',
            `: Promise.resolve().then(${this.basicFunction(
              '',
      ...
      `${RuntimeGlobals.definePropertyGetter}(exports, 'get', ${this.basicFunction('', 'return get')});`,
    ])
  }
